...
Escribiendo $g=\mathcal Rf$, desde el punto de vista computacional
el método tiene la estructura
\[
\begin{aligned}
\text{proyecciones}
&\xrightarrow{\mathcal F_t}\widehat g
\xrightarrow{\times |\sigma|}\widehat g_{\mathrm{filt}},\\
\widehat g_{\mathrm{filt}}
&\xrightarrow{\mathcal F_t^{-1}}g_{\mathrm{filt}}
