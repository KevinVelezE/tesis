...
\texttt{circle=True}.
\]
La opción de geometría circular en la generación del sinograma mantiene $N_t=256$. La longitud $N_{\mathrm{fft}}=1024$ se usa solo como longitud auxiliar para el filtrado por FFT con zero-padding centrado.
