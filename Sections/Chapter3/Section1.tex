...
El sinograma se genera con la rutina \texttt{radon} de \texttt{scikit-image} \cite{vanderwalt2014scikitimage}, usando la opción \texttt{circle=True}. Esta opción supone que la imagen es nula fuera del círculo inscrito en la malla y permite conservar $N_t=N=256$ muestras de detector. No describe una geometría de adquisición circular: la adquisición sigue correspondiendo a una geometría de haz paralelo.
