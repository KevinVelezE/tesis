...
\right],
\]
donde $\mathcal R$ denota la transformada de Radon, definida en la Sección~\ref{RadonBackprojection}, y $\mathcal F_t$ denota la transformada de Fourier unidimensional respecto de la variable $t$, con las convenciones fijadas en la Sección~\ref{FourierConventions}.
